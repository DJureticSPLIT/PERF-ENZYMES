...
C
C The output of the program HsKYN66-SimIandIIsX.for are KYN66P0075-sXe.dat, KYN66P0075mM-SimIIsX.dat,
C and KYN66P0075mM-SimIsX.dat.
C The first row with numbers from the HsKYN66P0075mM-SimIIsX.dat must give the same parameters
C already contained in the single row with numbers from the HsKYN66P0075-sXe.dat.
...
C
C
            open (unit=11,status='unknown',file='KYN66P0075-sXe.dat',
...
C
      close (unit=11)
C
        open (unit=13,status='unknown',file='KYN66P0075mM-SimIIsX.dat',
     & access='sequential',form='formatted')
       write(13,65)
