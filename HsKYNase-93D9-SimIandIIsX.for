...
C
C The output of the program HsKYN93D9-SimIandIIsX.for are KYN93D9P021mM-sXe.dat, KYN93D9P021mM-SimIIsX.dat,
C and KYN93D9P021mM-SimIsX.dat.
...
C
C The first row's k(cat) value should be similar to the 0.68 inverse seconds (Karamitros-2024).
C
...
C
C
        open (unit=13,status='unknown',file='KYN93D9P021mM-SimIIsX.dat',
     & access='sequential',form='formatted')
       write(13,65)
...
C
       close (unit=13)
C
        open (unit=9,status='unknown',file='KYN93D9P021mM-SimIsX.dat',
     & access='sequential',form='formatted')
       write(9,45)
